            ...
            <div class="col">
                <div class="card">
                    <h3 class="card-header d-flex justify-content-between align-items-center">
                        Data Kategori
                        <button class="btn btn-icon btn-info" type="button" v-b-modal.modalkategori v-on:click="Add">
                    ...
                    <div class="table-responsive">
                        <b-table striped hover :items="kategori" :fields="fields" class="table align-items-center table-flush">
                            <template v-slot:cell(Aksi)="data">
                                <b-button size="sm" v-on:click="Edit(data.item.id_kategori)" v-b-modal.modalkategori class="btn-success">Ubah</b-button>&nbsp;
                                <b-button size="sm" v-on:click="Drop(data.item.id_kategori)" class="btn-danger">Hapus</b-button>
                            </template>
                        </b-table>
